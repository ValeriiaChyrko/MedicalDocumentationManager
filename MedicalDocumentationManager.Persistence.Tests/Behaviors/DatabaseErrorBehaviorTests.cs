...
public class DatabaseErrorBehaviorTests
{
    ...
    public class TestDbUpdateException : DbUpdateException
    {
        ...
        public void AddEntry(Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry entry)
        {
            (Entries as List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry>)?.Add(entry);
        }
    }
}