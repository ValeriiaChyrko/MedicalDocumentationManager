...
public static class PatientsDataTableSeed
{
    internal static List<PatientEntity> SeedPatients(IReadOnlyList<AddressEntity> addressEntities)
    {
        ...
        string[] names = { "Daniel Johnson", "Olivia Davis", "William Wilson", "Isabella Martinez", "Liam Anderson", 
        ...
        for (var i = 0; i < maxRecordAmount; i++)
        {
            ...
            var patient = new PatientEntity
            {
                ...
                PhoneNumber = $"+1-{phonePrefixes[random.Next(phonePrefixes.Length)]}-{random.Next(100, 1000)}-{random.Next(1000, 10000)}",
